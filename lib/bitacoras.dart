...
class BitacorasPag extends StatefulWidget {
  final String vehiculoId;

  const BitacorasPag({Key? key, required this.vehiculoId}) : super(key: key);

  @override
  State<BitacorasPag> createState() => _BitacorasPagState();
}

class _BitacorasPagState extends State<BitacorasPag> {
